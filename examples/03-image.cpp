  ...
  outColor = texture(tex,fs_in.texCoord);\n\
    ...
    void createDescriptorSets() {
        ...
        std::transform(bindings.begin(), bindings.end(), poolSizes.begin(), [](auto &&e) {
            return Shit::DescriptorPoolSize{e.descriptorType, e.descriptorCount};
        });
    ...
    void updateDescriptorSets() {
        Shit::DescriptorImageInfo imageInfo{.pSampler = sampler,
                                            .pImageView = testImageView,
                                            .imageLayout = Shit::ImageLayout::SHADER_READ_ONLY_OPTIMAL};
    ...
    void recordCommandBuffer(Shit::CommandBuffer *commandBuffer, uint32_t imageIndex) {
        ...
        Shit::BindDescriptorSetsInfo info{Shit::PipelineBindPoint::GRAPHICS, pipelineLayout, 0,
