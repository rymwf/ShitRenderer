...
";
    ...
    void createDescriptorSets() {
        ...
        std::vector<Shit::DescriptorPoolSize> poolSizes{{Shit::DescriptorType::COMBINED_IMAGE_SAMPLER, count},
                                                        {Shit::DescriptorType::UNIFORM_BUFFER, count}};
        Shit::DescriptorPoolCreateInfo descriptorPoolCreateInfo{static_cast<uint32_t>(descriptorSetLayouts.size()),
    ...
    void createRenderPasses() {
        ...
        std::vector<Shit::AttachmentReference> resolveAttachments{{1, Shit::ImageLayout::COLOR_ATTACHMENT_OPTIMAL}};
    ...
    void createFramebuffers() {
        ...
        for (uint32_t i = 0; i < count; ++i) {
            Shit::ImageView *imageViews[] = {colorImageView, swapchain->GetImageViewByIndex(i)};
    ...
    void createImages() {
        ...
        testImage->GenerateMipmap(Shit::Filter::LINEAR, imageCreateInfo.initialLayout,
        ...
        Shit::ImageViewCreateInfo imageViewCreateInfo{
            ...
            .format = Shit::Format::R8G8B8A8_SRGB,
            .subresourceRange = {Shit::ImageAspectFlagBits::COLOR_BIT, 0, testImage->GetCreateInfoPtr()->mipLevels, 0,
                                 1},
        };
    ...
    void createColorResources() {
        ...
        Shit::ImageViewCreateInfo imageViewCreateInfo{colorImage,
