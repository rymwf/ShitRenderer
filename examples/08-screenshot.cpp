...
public:
    static void key_callback(GLFWwindow *pWindow, int key, int scancode, int action, int mods) {
        ...
        if (key == GLFW_KEY_P && action == GLFW_RELEASE) {
            auto app = (Hello *)glfwGetWindowUserPointer(pWindow);
            app->startScreenshot = true;
        }
    }
    void initWindow() {
        glfwInit();
...
";
    ...
    void createSwapchain() {
        ...
        swapchain = surface->Create(Shit::SwapchainCreateInfo{
            device,
    ...
    void createDescriptorSets() {
        ...
        Shit::DescriptorPoolCreateInfo descriptorPoolCreateInfo{
            (uint32_t)descriptorSetLayouts.size(), static_cast<uint32_t>(poolSizes.size()), poolSizes.data()};
    ...
    void createImages() {
        ...
        testImage->GenerateMipmap(Shit::Filter::LINEAR, Shit::ImageLayout::SHADER_READ_ONLY_OPTIMAL,
        ...
        Shit::ImageViewCreateInfo imageViewCreateInfo{
            ...
            .format = Shit::Format::R8G8B8A8_SRGB,
            .subresourceRange = {Shit::ImageAspectFlagBits::COLOR_BIT, 0, mipmapLevels - 1, 0, 1},
        };
