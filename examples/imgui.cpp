...
static auto vertShaderPath = "imgui/display.vert";
static auto fragShaderPath = "imgui/display.frag";
static auto testModelPath = SHIT_SOURCE_DIR "/testAssets/models/obj/viking_room/viking_room.obj";
...
public:
    ...
    void setupImGui() {
        ...
        // // set light
        // auto lightTransform = light->getParentTransform();
        // glm::vec3 translation = lightTransform->getLocalTranslation();
        // glm::vec3 rotation = glm::degrees(glm::eulerAngles(lightTransform->getLocalRotation()));
        // glm::vec3 scale = lightTransform->getLocalScale();
