...
namespace Shit
{
	...
	{
		return vkBorderColorArray[static_cast<size_t>(color)];
	}
	...
	VkImageCreateFlags Map(ImageCreateFlagBits flags)
	{
		return static_cast<VkImageCreateFlags>(flags) & 0x0fffffff;
	}
